...
using MemberDto = Model.Entities.Member;
...
namespace DataAccess.Repositories.Implementations
{
    public class MemberRepository : IMemberRepository
    {
        ...
        public MemberDto Get(int id)
        {
            ...
            var qryDb = _dbContext.Members.Where(mbr => !mbr.IsDeleted && mbr.Id == id);
        ...
        public MemberDto GetMemberByPersonId(int personId)
        {
            var qryDb = _dbContext.Members.Where(mbr => !mbr.IsDeleted && mbr.PersonId == personId);
